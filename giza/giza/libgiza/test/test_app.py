...
class CommonAppSuite(object):
    ...
    def test_pool_setter_invalid_input(self):
        ...
        self.app.pool = 1
        self.app.create_pool()
        self.assertIn(type(self.app.pool), list(self.app.pool_mapping.values()))
        self.assertTrue(self.app.has_active_pool())
    ...
    def test_description(self):
        ...
        self.assertEqual(0, len(sub_app.queue))
        self.assertTrue(sub_app.description.endswith(": []"))
        self.assertEqual(1, len(self.app.queue))
...
class TestBuildAppStandardConfig(CommonAppSuite, TestCase):
    ...
    def test_force_options(self):
        self.assertEqual(self.c.runstate.force, self.app.force)
    ...
    def test_default_pool_size(self):
        ...
        self.assertEqual(self.c.runstate.pool_size, self.app.pool_size)
