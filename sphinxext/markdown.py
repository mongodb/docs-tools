...
class MarkdownTranslator(sphinx.writers.text.TextTranslator):
    ...
    def visit_entry(self, node):
        ...
        if 'morerows' in node or 'morecols' in node:
            warn('Column or row spanning cells are not implemented', node)
        self.new_state(0)
