...
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'fabric')))
...
def include_file_data(conf):
    ...
    recursive_use = fabfile.includes.included_recusively(include_graph)
    generated = fabfile.includes.generated_includes(conf)
